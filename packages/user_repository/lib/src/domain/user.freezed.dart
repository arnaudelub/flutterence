...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, displayName: $displayName, isAdmin: $isAdmin, isSpecialGuest: $isSpecialGuest, isFlutterTeam: $isFlutterTeam, notificationEnabled: $notificationEnabled, creationDate: $creationDate, avatar: $avatar, notificationToken: $notificationToken)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      required DateTime creationDate,
      String? avatar,
      String? notificationToken}) = _$_User;
